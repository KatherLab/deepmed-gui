...
class Ui_gui_histo_main(object):
    def setupUi(self, gui_histo_main):
        ...
        self.gridLayout.addWidget(self.addcohortlist_DL, 13, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.del_list_DL, 14, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.groups_Deploy, 11, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.reset_Deploy, 13, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.choose_tiledir_Deploy, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.subgroups_Deploy, 11, 1, 1, 1)
        self.clini_table_Deploy = QtWidgets.QPushButton(self.Deploy)
        self.clini_table_Deploy.setObjectName("clini_table_Deploy")
        self.gridLayout_2.addWidget(self.clini_table_Deploy, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.targetlabels2_Deploy, 12, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.cohortlist_Deploy, 2, 3, 7, 1)
        ...
        self.gridLayout_2.addWidget(self.choose_model_Deploy, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.targetlabels_Deploy, 12, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.addlist_Deploy, 7, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.del_list_deploy, 8, 2, 1, 1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/l_arr.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.prevIm_Vis.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/r_arr.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.nextIm_Vis.setIcon(icon3)
    ...
    def retranslateUi(self, gui_histo_main):
        ...
        self.label_32.setText(_translate("gui_histo_main", " "))
        ...
        self.label_33.setText(_translate("gui_histo_main", " "))
