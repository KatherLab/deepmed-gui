...
class Ui_gui_histo_main(object):
    def setupUi(self, gui_histo_main):
        ...
        self.cohortlist_DL = QtWidgets.QListWidget(self.Deeplearn)
        self.cohortlist_DL.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        self.cohortlist_DL.setObjectName("cohortlist_DL")
        self.gridLayout.addWidget(self.cohortlist_DL, 14, 4, 3, 1)
        ...
        self.gridLayout.addWidget(self.run_DL, 23, 1, 1, 1)
    ...
    def retranslateUi(self, gui_histo_main):
        ...
        self.cohortlist_DL.setSortingEnabled(True)
        ...
        self.pushButton.setText(_translate("gui_histo_main", "subgroups"))
