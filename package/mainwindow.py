...
class Ui_gui_histo_main(object):
    def setupUi(self, gui_histo_main):
        ...
        self.cohort_click = QtWidgets.QPushButton(self.Deeplearn)
        self.cohort_click.setObjectName("cohort_click")
        self.gridLayout.addWidget(self.cohort_click, 21, 1, 1, 1)
        ...
        self.validratio_DL = QtWidgets.QSpinBox(self.Deeplearn)
        self.validratio_DL.setMaximum(100)
        self.validratio_DL.setProperty("value", 20)
    ...
    def retranslateUi(self, gui_histo_main):
        ...
        self.cohort_click.setText(_translate("gui_histo_main", "subgroups"))
        ...
        self.validratio_DL.setSuffix(_translate("gui_histo_main", "%"))
