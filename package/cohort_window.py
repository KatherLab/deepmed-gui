...
class Ui_cohort_settings(object):
    def setupUi(self, cohort_settings):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 449, 533))
        ...
        self.gridLayout.addWidget(self.querybox, 17, 0, 1, 2)
        ...
        self.median_label = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.median_label.setEnabled(False)
        self.median_label.setObjectName("median_label")
        self.gridLayout.addWidget(self.median_label, 12, 0, 1, 1)
