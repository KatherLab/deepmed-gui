...
class Ui_cohort_settings(object):
    def setupUi(self, cohort_settings):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 449, 476))
        ...
        self.gridLayout.addWidget(self.querybox, 13, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.horizontalScrollBar, 8, 0, 1, 2)
        ...
        self.min = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.min.setEnabled(False)
        self.min.setObjectName("min")
        self.gridLayout.addWidget(self.min, 6, 0, 1, 1)
    ...
    def retranslateUi(self, cohort_settings):
        ...
        self.label_8.setText(_translate("cohort_settings", "max"))
        ...
        self.min.setText(_translate("cohort_settings", "min"))
