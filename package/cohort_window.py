...
class Ui_cohort_settings(object):
    def setupUi(self, cohort_settings):
        ...
        self.gridLayout.addWidget(self.subgroups, 7, 0, 1, 6)
        self.label_3 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 17, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.or_button, 6, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.and_button, 5, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.line, 8, 0, 1, 6)
        self.back_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.back_button.setEnabled(False)
        self.back_button.setObjectName("back_button")
        self.gridLayout.addWidget(self.back_button, 7, 6, 1, 1)
    ...
    def retranslateUi(self, cohort_settings):
        ...
        self.label_4.setText(_translate("cohort_settings", "Create Subset"))
